                    ...
                    <form className="theme_form">
                        ...
                        <div className="form_row">
                            <Form.Group className="form-group" controlId="">
                                ...
                                <Form.Check type="radio"  label="Customize Catering (The price will be depending on selections)" checked />
                                <Form.Check type="radio"  label="Preset  Catering (Add your price please}" />
                            </Form.Group>  
                        </div>
