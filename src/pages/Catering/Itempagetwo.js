          ...
          <form className="theme_form">
            ...
            <div className="form_row">
              <Form.Group className="form-group" controlId="">
                ...
                <Form.Check
                  type="radio"
                  label="Customize Catering (The price will be depending on selections)"
                  checked
                />
                <Form.Check
                  type="radio"
                  label="Preset  Catering (Add your price please}"
                />
              </Form.Group>
            </div>
            ...
            <div className="catring_type_pack">
              <div className="prest_header">
                <h4>Package 1</h4>
                <a href="#" className="btn btn-primary view_packeg">
                  View Packages
                </a>
              </div>
              ...
              <Row className="package_column">
                ...
                <Col md={8}>
                  <div className="pack_menu_item catering_Page_wrapper item-page-two">
