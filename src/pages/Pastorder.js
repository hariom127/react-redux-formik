                ...
                <h2 className="dashboard_title">Past Orders</h2>
                    ...
                    <div className="order_list_head">
                        <div className="order_left_info">
                            ...
                            <span className="datetime"><i class="far fa-clock"></i>10:20 am, 10 August 2021</span>
                        </div>
                    ...
                    <div className="order_list_outer">
                        ...
                        <div class="list_inner">
                            <figure><img src="./assets/images/chart.jpg" /></figure>
                             <div className="past-order_detail">
                                ...
                                <p>A pizza loaded with crunchy onions, crisp capsicum,<br/> juicy tomatoes and jalapeno</p>  
                             </div>
                             <strong className="price_value">BD 2.500</strong>
                        </div>

                        <div class="list_inner">
                            <figure><img src="./assets/images/chart2.jpg" /></figure>
                             <div className="past-order_detail">
                                <h5><a href="#">Veggie Paradise</a></h5>
                                <p>A pizza loaded with crunchy onions, crisp capsicum,<br/> juicy tomatoes and jalapeno with a liberal sprinkling<br/> of exotic Mexican herbs</p>  
                             </div>
                             <strong className="price_value">BD 2.500</strong>
                        </div>
                     ...
                     <div className="discount_row"><span className="discount_tag">Discount</span><span className="discount_value">BHD05.00</span></div>
