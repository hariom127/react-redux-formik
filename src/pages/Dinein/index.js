  ...
  return (
    <Layout sidebar header>
              ...
              <Tab eventKey="request" title="New Request">
                <div className="dinein_tab_contant_wrapper">
                  <div className="new_request">
                    <span className="request_number">
                      Request Number:#65645641
                    </span>
                    <ul className>
                      <li>
                        <h6>Hussain</h6>
                        <span className="valuedinen">+973-6556456145</span>
                      </li>
                      <li>
                        <h6>Request Type</h6>
                        <span className="valuedinen">Dine in</span>
                      </li>
                      <li>
                        <h6>Dine in Date and time</h6>
                        <span className="valuedinen">
                          15 Sep. 2021, 07:00 PM
                        </span>
                      </li>
                      <li>
                        <h6>No. of persons</h6>
                        <span className="valuedinen">10 Persons</span>
                      </li>
                      <li>
                        <h6>Special Note</h6>
                        <span className="valuedinen">
                          I want table in the corner
                        </span>
                      </li>
                      <li>
                        <h6>Request Status</h6>
                        <span className="valuedinen">Unknown</span>
                      </li>
                    </ul>
      ...
      <Modal
        show={show}
        onHide={handleClose}
        className="select_date_modal_outer"
      >
        ...
        <Modal.Body>
          <div className="select_date">
            <ul>
              <li>
                <p>
                  <h6>Order No. :</h6> <span>#4534534523324</span>
                </p>
                <p>
                  <h6>Time:</h6> <span> 10:30 PM 21 Sep. 2021</span>
                </p>
              </li>
              <li>
                <p>
                ...
                <p>
                  <h6>Order No. :</h6> <span>12:30 PM 19 Sep. 2021</span>
                </p>
              </li>
              <li>
                <p>
